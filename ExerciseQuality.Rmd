...
---
# Classification of quality of Exercise using monitor data
...
These are five classificaitons of this exercise, one method is the correct form of the exercise while the other four are common mistakes: exactly accorgind to the specification (Class A), throwing the elbows to the front (Class B), lifting the dumbbell only halfway (Class C), lowering the dumbbell only halfway (Class D) and throwing the hihps to the front (Class E).
...
And then to install the packages that will be used: caret and rattle.
